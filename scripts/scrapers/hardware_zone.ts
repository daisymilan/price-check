...
// Site is WooCommerce, not Shopify — /collections/all doesn't exist and a
// catch-all redirect sends it to one unrelated single product page, which is
// why the old scraper only ever found ~4 products. Verified real category
// pages below return 200 with real li.product listings.
const CATEGORY_PAGES = [
  '/product-category/power-tools/',
  '/product-category/hand-tools/',
  '/product-category/building-supplies/',
];
